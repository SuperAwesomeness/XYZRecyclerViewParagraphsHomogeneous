...
//        mStatusBarColorDrawable = new ColorDrawable(0);
        ...
        toolbarHeaderView = (HeaderView) mRootView.findViewById(R.id.toolbar_header_view);
        floatHeaderView = (HeaderView) mRootView.findViewById(R.id.float_header_view);
...
//        bylineView.setMovementMethod(new LinkMovementMethod());
        ...
        RecyclerView recyclerView = (RecyclerView) mRootView.findViewById(R.id.article_detail_rv);
        ...
        if (mCursor != null) {
            ...
            if (!publishedDate.before(START_OF_EPOCH.getTime())) {
                articleSubtitle = String.valueOf(Html.fromHtml(
...
//            }
            ...
            toolbarHeaderView.bindTo(articleTitle, articleSubtitle);
            floatHeaderView.bindTo(articleTitle, articleSubtitle);
...
//            bodyView.setText(Html.fromHtml(mCursor.getString(ArticleLoader.Query.BODY).replaceAll("(\r\n|\n)", "<br />")));
            ...
            articleAdapter.setArticleData(articleBody);
